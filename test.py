...
img_path = "D:\\Studia\\Semestr 5\\WDPO Lab\\projekt\\WDPO\\data\\12.jpg"
cv2.namedWindow('hsv')
...
# #TUTAJ MASKI
# mask_hsv_green = cv2.inRange(hsv, (33, 190, 0), (146, 255, 200))
# mask_hsv_purple = cv2.inRange(hsv, (138, 49, 38), (170, 255, 255))
...
# kernel2 = np.ones((5, 5), np.uint8)#5, 5 green,
